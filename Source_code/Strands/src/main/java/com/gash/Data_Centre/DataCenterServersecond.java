...
public class DataCenterServersecond {

    private Server my_server;

    public static String path;
    private int port;
    DataCenterServersecond(String path, int port){
        this.path=path;
        this.port=port;
    }
    ...
    public static void main(String args[]) {
        DataCenterServersecond dataCenterServer = new DataCenterServersecond("D:/CMPE275/dc2/",9001);
        //DataCenterServersecond dataCenterServer1 = new DataCenterServersecond("D:/CMPE275/dc2/",9001);
try {
   ...
   // dataCenterServer1.start();
    ...
    static public class DataTransferServiceImpl extends DataTransferServiceGrpc.DataTransferServiceImplBase
    {
        ...
        public void downloadChunk(final grpc.Chat.ChunkInfo request, StreamObserver<Chat.FileMetaData> responseObserver)
        {
            ...
            System.out.println("PROXY SERVER: "+ file_chunk_tosend);
